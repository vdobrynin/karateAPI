...
//       .feed(tokenFeeder)
    ...
    val createArticle = scenario("Create & Delete Article").feed(csvFeeder).exec(karateFeature("classpath:conduitApp/performance/createArticle.feature"))
    ...
    setUp(
        createArticle.inject(
            ...
            // constantUsersPerSec(2) during (10 seconds),              // #40 commenting temp
